;jQuery(document).ready(function ($) {
  ...
  $('.github-widget').each(function () {
    ...
    $widget = $(
      '<div class="mdl-card mdl-shadow--2dp mdl-cell--6-col">'
      ...
      + '<a href="' + repoUrl + '#readme"><i class="material-icons" role="presentation">arrow_forward</i></a>'
      + '</div>'
      ...
      + '</button>'
      + '<a href="' + repoUrl + '#readme" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect">'
    ...
    $.ajax({
      ...
      success: function (results) {
        ...
        $widget.find('.updated').html('最新的提交分支是 <strong>' + repo.default_branch + '</strong> ');
