;jQuery(document).ready(function ($) {
  ...
  $('.github-widget').each(function () {
    ...
    $widget = $(
      ...
      + '</div>'
      + '</div>'
      + '<div class="github-box-content mdl-card__supporting-text">'
      ...
      + '<span>'
      + 'star: <a class="watchers" href="' + repoUrl + '/watchers" title="See watchers">?</a>'
      + '</span>'
      + '<span>'
      + 'fork:<a class="forks" href="' + repoUrl + '/network/members" title="See forkers">?</a>'
      + '</span>'
      + '<a id="visit_github" target="_blank" href="' + repoUrl + '#readme" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect">'
      + '<i class="material-icons">share</i>'
      + '</a>'
      + '<div class="mdl-tooltip" data-mdl-for="visit_github">访问 GitHub</div>'
      + '</div>'
    );
    ...
    $.ajax({
      ...
      success: function (results) {
        ...
        $widget.find('.updated').html('最新的提交是 <strong>' + repo.default_branch + '</strong> ');
